...
if ($nom_recette) {
    ...
    if ($details_recette_data !== false) {
        ...
        echo "<a href='modificationRecette.php?nom=" . urlencode($details_recette->getNom()) . "'>Modifier cette recette</a>";
    } else {
        // Si aucune recette trouvée message d'erreur
        echo "<p>Recette non trouvée.</p>";
    }
} else {
    // Gérer le cas où le paramètre 'nom' n'est pas défini
    echo "<p>Le paramètre 'nom' n'est pas défini dans l'URL.</p>";
}
?>